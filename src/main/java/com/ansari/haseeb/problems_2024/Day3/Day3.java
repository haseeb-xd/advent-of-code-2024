package com.ansari.haseeb.problems_2024.Day3;
...
public class Day3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> lines = StringUtil.readLinesFromFile("src/main/java/com/ansari/haseeb/problems_2024/Day3/input.txt");
